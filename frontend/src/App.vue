...
const navigation = [
  { name: 'Main', href: '/', icon: HomeIcon, current: true },
  { name: 'Order', href: '/order', icon: UsersIcon, current: false },
                      ...
                      <li>
                        <ul role="list" class="-mx-2 space-y-1">
                          <li v-for="item in navigation" :key="item.name">
                            <RouterLink :to="item.href" :class="[item.current ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600', 'group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6']">
